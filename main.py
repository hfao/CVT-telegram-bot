...
# Kiểm tra nhóm có hoạt động không
...
async def handle_message(update: Update, context: CallbackContext):
    ...
    # Kiểm tra nếu tin nhắn từ nhân viên nội bộ
    ...
    keyboard = [[InlineKeyboardButton("Start", callback_data="start_conversation")]]
...
async def start_conversation(update: Update, context: CallbackContext):
    ...
    # Đảm bảo chỉ có nhân viên mới nhận được cuộc trò chuyện sau khi nhấn Start
